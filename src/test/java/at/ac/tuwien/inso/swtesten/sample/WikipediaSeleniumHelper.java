...
public class WikipediaSeleniumHelper {
	...
	public void selectLanguage(){
		driver.get(baseUrl);
		driver.findElement(By.cssSelector("div.central-featured-lang.lang5 > a.link-box > strong")).click();
	}
	...
	public void assertSearchResult(String articleName) throws Exception {
		assertEquals(articleName, driver.findElement(By.xpath("//h1[@id='firstHeading']/span")).getText());
	}
	...
	public void assertThatArticleNotExists(String articleName) {
		...
		assertEquals("Der Artikel „" + articleName + "“ existiert in der deutschsprachigen Wikipedia nicht. Du kannst den Artikel erstellen (Anleitung).\n"
